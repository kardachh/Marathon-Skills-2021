    ...
    public partial class EditRunner : MetroForm
    {
            ...
            try
               {
                    ...
                    MySqlCommand firstCommand = new MySqlCommand("SELECT user.FirstName, user.LastName, runner.Gender, runner.DateOfBirth, runner.CountryCode FROM Usеr, Runnеr WHERE user.Email = @email AND runner.Email = @email", Program.connection);
                    ...
                    reader.Close();
                    MySqlCommand secondCommand = new MySqlCommand("SELECT RunnerId FROM Runnеr WHERE Email = @email", Program.connection);
                    ...
                    MySqlCommand thirdCommand = new MySqlCommand("SELECT RaceKitOptionId, SponsorshipTarget, RegistrationStatusId FROM Registration WHERE RunnerId = @runnerId", Program.connection);
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MySqlCommand command = new MySqlCommand("UPDATE registration SET RegistrationStatusId = @RegistrationStatusId WHERE RunnerId = @RunnerId", Program.connection);
